...
const char* ssid1     = "evil";        //<-- ใส่ชือ Wifi หลัก ตรงนี
const char* password1 = "123456789o";    //<-- ใส่รหัส Wifi หลัก ตรงนี

const char* ssid2     = "evil";        //<-- ใส่ชือ Wifi หลัก ตรงนี
const char* password2 = "123456789o";    //<-- ใส่รหัส Wifi หลัก ตรงนี
...
String AcctName       = "amornlit";  //<-- ใส่ชือ User Name ตรงนี
String BrdNm          = "ESP01-001"; //<-- ใส่ชือ RigName ตรงนี
...
const String FirmwareVer={"2.8"}; // Last of Version
